...
Sequential guard: start this task only after task `097` is complete in `tasks/STATUS.md`, and therefore after task `096` is complete. No later-order task may begin until this task is complete.
