...
- Add a failing diagnostic artifact test proving unsupported AIR evidence is written under `artifacts/pipeline/<task-id>/experimental-backend-diagnostics/`.
...
- AIR failures write task-scoped diagnostics under `artifacts/pipeline/<task-id>/experimental-backend-diagnostics/`.
